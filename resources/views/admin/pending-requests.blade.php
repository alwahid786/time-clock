    ...
    <div class="container-fluid mt-3 mb-5" style="padding-left: 80px;">
        ...
        <div class="row">
            <div class="col-12 mt-4">
                <div class="card p-3">
                    <h4 class="px-3 text-center" style="color: #17a2b8;">Pending Requests</h4>
                    @if (session('success'))
                        ...
                        <tbody>
                            @forelse($requests as $request)
                                <tr>
                                    ...
                                    <td>{{ $request->memo }}</td>
                                    <td>
                                        <a href="{{ route('admin.approveRequest', $request->id) }}"
                                            class="btn btn-success btn-sm">Approve</a>
                                        <a href="{{ route('admin.rejectRequest', $request->id) }}"
