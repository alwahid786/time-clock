        ...
        <div class="row">
            <div class="col-12 d-flex align-items-center justify-content-between">
                <div class="tabSection">
                    ...
                    <a class="active" href="{{route('adminsList')}}">
                        Admins
                    </a>
                </div>
                <a href="{{route('addNewUser', ['type'=>'admin'])}}">
                    <button class="add_user_btn"><i class="fa-solid fa-user-plus mr-3"></i> Add New Admin</button>
                </a>
            </div>
        </div>
        <div class="row">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    <a class="tableIcons editIcon" href="javascript:void(0)"><i class="fa-solid fa-pencil"></i></a>
